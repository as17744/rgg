...
var Asset = ns.Asset = Hilo.Class.create({
    ...
    load: function(){
        var resources = [
            {id:'bg', src:'flappybird/images/bg.png'},
            {id:'ground', src:'flappybird/images/ground.png'},
            {id:'ready', src:'flappybird/images/ready.png'},
            {id:'over', src:'flappybird/images/over.png'},
            {id:'number', src:'flappybird/images/number.png'},
            {id:'bird', src:'flappybird/images/bird.png'},
            {id:'holdback', src:'flappybird/images/holdback.png'}
        ];
