...
/******/ 	return __webpack_require__(__webpack_require__.s = "./doc/mvvm/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _mvvm = __webpack_require__(/*! ./util/mvvm */ "./doc/mvvm/util/mvvm.js");
...
var _watcher = __webpack_require__(/*! ./watcher */ "./doc/mvvm/util/watcher.js");
...
var updater = {
    textUpdater: function textUpdater(node, value, oldval) {
...
var compileUtil = {
    ...
    bind: function bind(node, vm, exp, type) {
        var updateFunction = updater[type + 'Updater'];
...
Compile.prototype = {
    ...
    compileElement: function compileElement(el) {
        ...
        [].slice.call(childNodes).forEach(function (node) {
            ...
            var reg = /\{\{(.*)\}\}/;
            if (me.isNodeElement(node)) {} else if (me.isNodeText(node)) {
                var regMatch = text.match(reg);
                if (regMatch) {
                    me.compileText(node, regMatch[1]);
                }
            }
    ...
    isNodeElement: function isNodeElement(node) {
        return node.nodeType === 1;
    },
    isNodeText: function isNodeText(node) {
...
var Dep = {
    list: [],
    addDep: function addDep(watcher) {
...
var _observer = __webpack_require__(/*! ./observer */ "./doc/mvvm/util/observer.js");

var _observer2 = _interopRequireDefault(_observer);

var _compile = __webpack_require__(/*! ./compile */ "./doc/mvvm/util/compile.js");
...
Mvvm.prototype = {
    constructor: Mvvm,
    _setProxy: function _setProxy(key) {
        var vm = this;
    ...
    _initComputed: function _initComputed() {
        if ((0, _typeof3.default)(this.$options.computed) === 'object') {
            var vm = this;
            var computed = this.$options.computed;
            (0, _keys2.default)(computed).forEach(function (key) {
                (0, _defineProperty2.default)(vm, key, {
                    configurable: false,
                    enumerable: true,
                    get: function get() {
    ...
    _initMethods: function _initMethods() {
        if ((0, _typeof3.default)(this.$options.methods) === 'object') {
            var vm = this;
...
var _dep = __webpack_require__(/*! ./dep */ "./doc/mvvm/util/dep.js");
...
Observer.prototype = {
    ...
    defineReactive: function defineReactive(data, key) {
        var val = data[key];
...
function Watcher(vm, exp, update) {
    ...
    _dep2.default.addDep(this);
};
Watcher.prototype = {
    constructor: Watcher,
    update: function update() {
        var oldval = this.val;
        var val = this._getVal(this.vm, this.exp);
        typeof this.updater === 'function' && this.updater(val, oldval);
        this.val = val;
    },
    _getVal: function _getVal(vm, exp) {
        var val = vm;
        exp = exp.split('.');
        exp.forEach(function (k) {
            val = val[k];
